...
import { idlFactory } from './internet_computer_kyleGallego.did.js';
export { idlFactory } from './internet_computer_kyleGallego.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.INTERNET_COMPUTER_KYLEGALLEGO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./internet_computer_kyleGallego.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the internet_computer_kyleGallego canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./internet_computer_kyleGallego.did.js")._SERVICE>}
 */
export const internet_computer_kyleGallego = createActor(canisterId);
